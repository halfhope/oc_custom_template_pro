<?php
namespace Opencart\Catalog\Controller\Extension\CustomTemplate\Module;
class CustomTemplate extends \Opencart\System\Engine\Controller {
	...
	public function filter(string &$route, array &$data):void {
		...
		if(!$this->registry->has('custom_template')){
			$custom_template = new \Opencart\Extension\custom_template\System\Library\custom_template\Custom_template($this->registry);
