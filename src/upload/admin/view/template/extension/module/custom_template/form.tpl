...
<div class="form-group form-group-sm common required">
  <label class="col-sm-2 control-label"><span data-toggle="tooltip" data-html="true" title="<?php echo $entry_template_help; ?>"><?php echo $entry_template; ?></span></label>
  <div class="col-sm-10">
    <div class="input-group-sm">
      <input type="text" class="form-control" name="template" placeholder="<?php echo $text_template_placeholder; ?>" value="<?php echo isset($settings['template']) ? $settings['template'] : ''; ?>" required>
    </div>
  </div>
</div>
<!-- template end -->
...
<?php if ($layout_type == 'product' || $layout_type == 'default'): ?>
<!-- product start -->
...
<!-- product end -->
<!-- category start -->
<?php if ($layout_type == 'product' || $layout_type == 'category' || $layout_type == 'default'): ?>
...
<!-- category end -->
<!-- manufacturer start -->
<?php if ($layout_type == 'product' || $layout_type == 'manufacturer' || $layout_type == 'default'): ?>
...
<!-- manufacturer end -->
<!-- information start -->
<?php if ($layout_type == 'information' || $layout_type == 'default'): ?>
...
<!-- default start -->
<div class="form-group suseragent module common">
...
<div class="form-group scommon module common">
...
<div class="form-group <?php echo !isset($settings['total']['currency_id']) ? 'more_hidden' : ''; ?> scart module common">
...
<div class="form-group <?php echo !isset($settings['sub_total']['currency_id']) ? 'more_hidden' : ''; ?> scart module common">
...
<div class="form-group <?php echo !isset($settings['weight']['weight_class_id']) ? 'more_hidden' : ''; ?> scart module common">
...
<div class="form-group <?php echo !isset($settings['count']['enabled']) ? 'more_hidden' : ''; ?> scart module common">
...
<div class="form-group <?php echo !isset($settings['custom']['enabled']) ? 'more_hidden' : ''; ?> ssystem module common">
...
<div class="form-group <?php echo !isset($settings['platform']) ? 'more_hidden' : ''; ?> suseragent module common">
...
<div class="form-group <?php echo !isset($settings['browser']) ? 'more_hidden' : ''; ?> suseragent module common">
